 ...
 * @TODO
 */
function checkout_customizer_css() {
	...
	foreach ( $custom_css as $mod ) {
		checkout_generate_css( $mod['selector'], $mod['style'], $mod['theme_mod'] );
		echo "\n";
	}
...
add_action( 'wp_head', 'checkout_customizer_css' );
 ...
 * @since MyTheme 1.0
 */
function checkout_generate_css( $selector, $style, $mod_name, $prefix = '', $postfix = '', $echo = true ) {
	$return = '';
